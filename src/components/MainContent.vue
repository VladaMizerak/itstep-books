          ...
          <div class="row">
                <div class="col-7">
                  <div class="block1">
                        ...
                        <h1 class="text">якщо виникли питання, то залиш, будь ласка, нам своє повідомлення і наш менеджер зв'яжеться з тобою якомога швидше!</h1>
                        <h1 class="text">також слідкуй за нами в наших соціальних мережах, щоб дізнаватися про всі новини та рекомендації:</h1>
                  </div>
                ...
                <div class="col-5" id="contactform">
                  ...
                  <button class="submit" type="button"><img src="./img/submit.svg"></button>
